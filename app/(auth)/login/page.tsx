    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--background)' }}>
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted mt-1">Your AI-powered life RPG</p>
        </div>
        ...
        <div className="card">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-xl text-sm transition-colors outline-none focus:ring-2 focus:ring-teal-500"
                style={{
          ...
          <button
            ...
            className="w-full py-2.5 rounded-xl font-medium text-sm flex items-center justify-center gap-2 transition-opacity disabled:opacity-50"
            style={{
              background: 'var(--surface-2)',
              border: '1px solid var(--border)',
              color: 'var(--foreground)',
        ...
        <p className="text-center text-sm text-muted mt-4">
          ...
          <Link href="/signup" className="font-medium" style={{ color: '#14b8a6' }}>
            Sign up free
          </Link>
        </p>
      </div>
